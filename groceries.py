...
#adapted from prof-rossetti
def to_usd(my_price):
    return f"${my_price:,.2f}"

products = sorted(products, key=lambda n: n["name"])
productsLength = len(products)

print("--------------")
print(f"THERE ARE {productsLength} PRODUCTS")
print("--------------")
...
#############################
#  done sorting + printing  #
#############################

products = sorted(products, key=lambda n: n["department"])
